...
describe('Profile Error Handling and Recovery', () => {
    describe('localStorage Error Handling', () => {
        it('should handle localStorage.removeItem errors with fallback cleanup', async () => {
            ...
            // Confirm logout
            const confirmButton = await screen.findByRole('button', { name: /yes, logout/i });
            ...
            expect(mockSessionStorage.removeItem).toHaveBeenCalledWith('manualAuthUser');
        });
        ...
        it('should show user-friendly error message for storage errors', async () => {
            ...
            await waitFor(() => {
                ...
                expect(screen.getByText(/try refreshing the page or clearing your browser cache/i)).toBeInTheDocument();
            });
        });
    });
    ...
    describe('Retry Logic', () => {
        ...
        it('should show retry count in error message', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText(/logout failed.*attempts/i)).toBeInTheDocument();
            });
        });
    ...
    describe('User-Friendly Error Messages', () => {
        ...
        it('should show help text with recovery steps', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText(/close your browser completely for security/i)).toBeInTheDocument();
            });
        });
    });
