...
const longAnnouncement = {
  id: '1',
  message: 'This is a very long announcement message that should be properly truncated on mobile devices to ensure optimal user experience and readability across all screen sizes and device types.',
