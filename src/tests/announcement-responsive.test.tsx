...
const mockAnnouncements = [
  {
    id: '1',
    message:
      'This is a very long announcement message that should be truncated on mobile devices to ensure proper display and readability across different screen sizes and device types.',
  ...
  },
  {
    id: '3',
    message:
      'Another long announcement that needs to be tested for proper truncation behavior on small screens and mobile devices to ensure the user interface remains clean and accessible.',
...
describe('Announcement Responsive Design', () => {
  ...
  describe('Auto-scroll Functionality', () => {
    ...
    it('should have auto-scroll functionality enabled', () => {
      ...
      expect(
        screen.getByText(/This is a very long announcement/)
      ).toBeInTheDocument();
    ...
    it('should not auto-scroll with single announcement', () => {
      ...
      expect(
        screen.queryByRole('button', { name: /go to announcement/i })
  ...
  describe('Performance and Accessibility', () => {
    it('should not cause layout shifts during transitions', () => {
      const { rerender } = render(
        <AnnouncementsBanner announcements={mockAnnouncements} />
      );
