...
const LiveClass = lazy(() =>
  import('./pages/LiveClass').then(module => ({ default: module.LiveClass }))
);
const Recordings = lazy(() =>
  import('./pages/Recordings').then(module => ({ default: module.Recordings }))
);
const NotesExercises = lazy(() =>
  import('./pages/NotesExercises').then(module => ({
    default: module.NotesExercises,
  }))
);
const ExamsAttendance = lazy(() =>
  import('./pages/ExamsAttendance').then(module => ({
    default: module.ExamsAttendance,
  }))
);
const Profile = lazy(() =>
                    ...
                    <Suspense fallback={<PageLoadingFallback />}>
                      <Routes>
                        ...
                        <Route
                          ...
                          element={
                            <ProtectedRoute>
                              <Layout showBackButton={true} title="Profile">
                                <Profile />
                              </Layout>
                            </ProtectedRoute>
                          }
