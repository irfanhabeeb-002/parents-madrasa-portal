...
describe('InstallPrompt Motion and Animation Preferences', () => {
  ...
  describe('Conditional Animation Classes', () => {
    ...
    it('should conditionally apply close button animations', async () => {
      ...
      await waitFor(() => {
        const closeButton = screen.getByRole('button', { name: /dismiss install banner/i });
  ...
  describe('Modal Animation Preferences', () => {
    it('should apply modal button animations when motion is allowed', async () => {
      ...
      await waitFor(() => {
        const learnMoreButton = screen.getByRole('button', { name: /learn more about installing/i });
        fireEvent.click(learnMoreButton);
      });

      await waitFor(() => {
        const modalInstallButton = screen.getByRole('button', { name: /install madrasa portal app now on your device/i });
