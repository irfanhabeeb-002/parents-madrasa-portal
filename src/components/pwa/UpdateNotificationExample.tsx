...
export const UpdateNotificationExample: React.FC = () => {
  const { updateAvailable, isUpdating, updateError, offlineReady } =
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-8">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <p className="text-gray-600 mb-6">
          This demonstrates the PWA update notification system with automatic
          detection and manual update triggers.
        </p>
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-6">
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span
                className={updateAvailable ? 'text-green-600' : 'text-gray-500'}
              >
            ...
            <div className="flex justify-between">
              ...
              <span
                className={offlineReady ? 'text-green-600' : 'text-gray-500'}
              >
                {offlineReady ? 'Yes' : 'No'}
              </span>
            </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            <li>
              • Deploy a new version of the app to trigger update detection
            </li>
            <li>• Use the manual update buttons to check for updates</li>
            <li>
              • The automatic notification will appear when updates are
              available
            </li>
            <li>
              • Updates can be dismissed and will reappear after 5 minutes
            </li>
          </ul>
        </div>
      </div>
