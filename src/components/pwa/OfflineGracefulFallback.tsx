 ...
 */
export const OfflineGracefulFallback: React.FC<
  OfflineGracefulFallbackProps
> = ({
  feature,
  children,
  fallbackContent,
  ...
  const { isOnline, shouldShowOfflineMessage, getOfflineMessage } =
    useOfflineGracefulDegradation();
      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-yellow-700 mt-1">
            Some features may load slowly or be temporarily disabled for better
            performance.
          </p>
        </div>
        {onOptimize && (
