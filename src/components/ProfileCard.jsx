  ...
  return (
    <div className="max-w-xs w-full bg-white border border-gray-200 rounded-xl overflow-hidden shadow-[0_10px_25px_-5px_rgba(0,0,0,0.05),0_8px_10px_-6px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_25px_-5px_rgba(0,0,0,0.08),0_15px_15px_-6px_rgba(0,0,0,0.06)] transition-all duration-300">
      ...
      <div className="py-1.5">
        ...
        <a
          href="#"
          className="group relative flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 transition-all duration-200"
        >
          ...
          <svg
            fill="currentColor"
            viewBox="0 0 20 20"
            className="h-3 w-3 text-gray-400 ml-auto group-hover:text-green-600"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              clipRule="evenodd"
        ...
        <a
          href="#"
          className="group relative flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-purple-50 transition-all duration-200"
        >
          ...
          <svg
            fill="currentColor"
            viewBox="0 0 20 20"
            className="h-3 w-3 text-gray-400 ml-auto group-hover:text-purple-600"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              clipRule="evenodd"
