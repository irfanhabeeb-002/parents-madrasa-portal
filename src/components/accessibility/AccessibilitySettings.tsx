  ...
  const settingsConfig = [
    {
      ...
      malayalamDescription: 'മികച്ച ദൃശ്യതയ്ക്കായി കോൺട്രാസ്റ്റ് വർദ്ധിപ്പിക്കുന്നു'
    },
    {
    ...
    },
    {
      ...
      malayalamDescription: 'സ്ക്രീൻ റീഡറുകൾക്കായി ഉള്ളടക്കം ഒപ്റ്റിമൈസ് ചെയ്യുന്നു'
    }
  ];
