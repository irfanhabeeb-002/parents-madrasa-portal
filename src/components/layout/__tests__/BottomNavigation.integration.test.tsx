...
const LiveClassPage = () => {
  const location = useLocation();
  return (
    <div data-testid="live-class-page">
      Live Class Page - {location.pathname}
    </div>
  );
};
...
const ProfilePage = () => {
  const location = useLocation();
  return (
    <div data-testid="profile-page">Profile Page - {location.pathname}</div>
  );
};
...
const SettingsPage = () => {
  const location = useLocation();
  return (
    <div data-testid="settings-page">Settings Page - {location.pathname}</div>
  );
};
