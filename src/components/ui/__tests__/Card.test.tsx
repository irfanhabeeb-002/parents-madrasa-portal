...
describe('Card', () => {
  ...
  it('applies correct variant classes', () => {
    ...
    const cardContainer = screen.getByText('Test').closest('div')?.parentElement
    expect(cardContainer).toHaveClass('shadow-sm')

    rerender(<Card title="Test" variant="elevated" />)
    const elevatedContainer = screen.getByText('Test').closest('div')?.parentElement
  ...
  it('renders as interactive button when onClick is provided', async () => {
    ...
    render(<Card title="Clickable Card" onClick={handleClick} variant="interactive" />)
  ...
  it('uses custom aria-label when provided', () => {
    render(<Card title="Test Card" onClick={() => {}} ariaLabel="Custom label" />)
  ...
  it('applies custom className', () => {
    ...
    // Find the outermost card container
    const cardContainer = screen.getByText('Test Card').closest('div')?.parentElement
  ...
  it('has proper touch target classes when interactive', () => {
    render(<Card title="Touch Card" onClick={() => {}} variant="interactive" />)
    const button = screen.getByRole('button')
