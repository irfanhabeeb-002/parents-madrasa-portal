...
describe('Modal', () => {
  ...
  it('has proper modal structure and styling', () => {
    ...
    // Check backdrop
    const backdrop = dialog.querySelector('.fixed.inset-0.bg-black.bg-opacity-50')
    expect(backdrop).toBeInTheDocument()
    
    // Check modal content container
    const modalContent = dialog.querySelector('.relative.bg-white.rounded-lg.shadow-xl')
