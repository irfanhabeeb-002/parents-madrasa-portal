...
export const NotificationDebugPanel: React.FC = () => {
  const { notifications, unreadCount, permission, requestPermission } =
    useNotifications();
        ...
        <div className="text-sm">
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <span
                className={`ml-1 ${permission.granted ? 'text-green-600' : 'text-red-600'}`}
              >
            ...
            <div>
              ...
              <span
                className={`ml-1 ${permission.supported ? 'text-green-600' : 'text-red-600'}`}
              >
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <AccessibleButton
              ...
              onClick={() => {
                ...
                (
                  window as any
                ).NotificationCustomizer?.scheduleCustomClassReminder(
                  'custom-test',
                  'Custom Test Class',
                  classTime,
            ...
            <AccessibleButton
              ...
              onClick={() => {
                ...
                (
                  window as any
                ).NotificationCustomizer?.testNotificationStyles();
              }}
              className="text-xs"
            >
              🎨 Styles
