  ...
  try {
    ...
    if (manifest.icons && Array.isArray(manifest.icons)) {
      ...
      if (hasMaskableIcon) {
        ...
        logWarning('Maskable icon missing (recommended for better Android integration)');
      }
    }
...
function checkHTTPSRequirement() {
  ...
  logInfo('Ensure your deployment platform enforces HTTPS for PWA functionality');
...
async function main() {
  ...
  log(`${colors.cyan}Validating PWA functionality for Parents Madrasa Portal${colors.reset}\n`);
